...
/** دواین بارکۆدی سکانکراو — لەنێوان BarcodeScannerScreen و AddItemScreen ـدا هاوبەشکراوە */
object BarcodeResultHolder {
    var value by androidx.compose.runtime.mutableStateOf<String?>(null)
}
        ...
        NavHost(
            ...
            composable(Routes.SCAN) {
                BarcodeScannerScreen(
                    onScanned = { code ->
                        BarcodeResultHolder.value = code
            ...
            composable(Routes.ACCOUNT) {
                AccountBackupScreen(onClose = { navController.popBackStack() })
            }
            ...
            composable(Routes.ABOUT) {
                AboutContactScreen(onClose = { navController.popBackStack() })
            }
        }
    }
}
